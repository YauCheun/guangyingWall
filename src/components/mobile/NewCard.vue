<template>
    <div class="new-card">
        ...
        <div>
            ...
            <p class="mzsm">
                光影是本人独自开发的，为便于与用户交流的留言平台。请不要利用此平台服务制作、上传、下载、复制、发布、传播或者转载如下内容：<br />
                1、反对宪法所确定的基本原则的；<br />
...
//图片提交
const updatePhoto = (data: { type: number; message: string; name: string; userId: string; moment: Date; label: number; color: number; imgurl: string; }) => {
    console.log(data)
